...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="container">
    <div class="card mx-auto mt-5">
      ...
      <div class="card-body">
        <form action="deletedistributor.php" method="post" >
...
while($data = mysqli_fetch_row($run))
{
  ?>
   ...
   <td><?php echo "$data[5]"; ?></td>
	...
	<td> <a href="updatedistributor.php?d_id=<?php echo $data[0]; ?>">Edit</a> | <a href="deletedistributor.php?did=<?php echo $data[0]; ?>">Delete</a></td>	
	</tr>
  <?php
}
