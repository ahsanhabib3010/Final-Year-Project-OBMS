...
public class Distributor_ViewOrder extends AppCompatActivity {
    ...
    ArrayList<Shopkeeper> listItems = new ArrayList<>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_distributor__view_order);

        listView = (ListView) findViewById(R.id.shopkeeper_list);
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if(jsonArray.length()>0){
                    ...
                    ShopkeeperAdapter adapter= new ShopkeeperAdapter(Distributor_ViewOrder.this,listItems);
